...
if &background=="light"
  ...
  hi! Label   guibg=bg guifg=#006699 ctermfg=24  cterm=bold gui=bold
  ...
  hi! Tag   guibg=bg guifg=#006699 ctermfg=24  cterm=bold gui=bold
  ...
  hi! Identifier   guibg=bg guifg=#87cefa ctermfg=117  cterm=bold gui=bold
  ...
  hi! PreCondit   guibg=bg guifg=#87cefa ctermfg=117  cterm=bold gui=bold
  ...
  hi! Tag   guibg=bg guifg=#00cc99 ctermfg=42  cterm=bold gui=bold
