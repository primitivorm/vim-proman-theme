...
if &background == "light"
  ...
  hi! Delimiter   guibg=bg guifg=#007A00 ctermfg=28  cterm=NONE gui=NONE
  ...
  hi! Special   guibg=bg guifg=#007A00 ctermfg=28  cterm=NONE gui=NONE
  ...
  hi! Typedef guibg=bg guifg=#006699 ctermfg=24 cterm=NONE gui=NONE
  ...
  hi! Function   guibg=bg guifg=#87cefa ctermfg=117 cterm=NONE gui=NONE
  ...
  hi! PreCondit   guibg=bg guifg=#ffff99 ctermfg=228  cterm=NONE gui=NONE
  ...
  hi! Typedef guibg=bg guifg=#87cefa ctermfg=117 cterm=NONE gui=NONE
...
hi! Directory   guibg=bg guifg=#ff5fff ctermfg=207
...
hi! Character    guibg=bg guifg=#ff5f00 ctermfg=202
hi! Define   guibg=bg guifg=#33adff ctermfg=75  cterm=NONE gui=NONE
...
hi! Identifier   guibg=bg guifg=#33adff ctermfg=75  cterm=NONE gui=NONE
...
hi! String   guibg=bg guifg=#ff5f00 ctermfg=202
...
hi! Title   guibg=#87cefa ctermbg=117  guifg=#ff5fff ctermfg=207
hi! Macro   guibg=bg guifg=#ff5fff ctermfg=207
hi! NERDTreeBookmarksLeader   guibg=bg guifg=#ff5fff ctermfg=207
...
"hi! default ShowMarksHLl ctermfg=darkblue ctermbg=blue cterm=NONE guifg=blue guibg=lightblue gui=NONE
"hi! default ShowMarksHLu ctermfg=darkblue ctermbg=blue cterm=NONE guifg=blue guibg=lightblue gui=NONE
"hi! default ShowMarksHLo ctermfg=darkblue ctermbg=blue cterm=NONE guifg=blue guibg=lightblue gui=NONE
"hi! default ShowMarksHLm ctermfg=darkblue ctermbg=blue cterm=NONE guifg=blue guibg=lightblue gui=NONE
