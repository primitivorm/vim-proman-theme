...
if &background=="light"
  ...
  hi Conditional ctermbg=bg ctermfg=104 gui=NONE guibg=bg guifg=#6a5acd
  hi Exception ctermbg=bg ctermfg=104 gui=NONE guibg=bg guifg=#6a5acd
  hi Function ctermbg=bg ctermfg=104 gui=NONE guibg=bg guifg=#6a5acd
  hi Operator ctermbg=bg ctermfg=104 gui=NONE guibg=bg guifg=#6a5acd
  hi Repeat ctermbg=bg ctermfg=104 gui=NONE guibg=bg guifg=#6a5acd
  hi RubySymbol ctermbg=bg ctermfg=104 gui=NONE guibg=bg guifg=#6a5acd
  hi Directory ctermbg=bg ctermfg=126 gui=NONE guibg=bg guifg=#990073
  hi NONEd ctermbg=bg ctermfg=126 gui=NONE guibg=bg guifg=#990073
  hi Statement ctermbg=bg ctermfg=126 gui=NONE guibg=bg guifg=#990073
  hi StorageClass ctermbg=bg ctermfg=126 gui=NONE guibg=bg guifg=#990073
  ...
  hi Function ctermbg=bg ctermfg=104 gui=NONE guibg=bg guifg=#ad85ff
  ...
  hi Statement ctermbg=bg ctermfg=126 gui=NONE guibg=bg guifg=#ff0066
