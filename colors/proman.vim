...
if &background=="light"
  ...
  hi Function ctermbg=bg ctermfg=199 gui=NONE guibg=bg guifg=#ff1493
  ...
  hi Statement ctermbg=bg ctermfg=199 gui=NONE guibg=bg guifg=#ff1493
  ...
  hi PreProc ctermbg=bg ctermfg=104 gui=NONE guibg=bg guifg=#6600cc
