...
if &background=="light"
  ...
  hi Conditional ctermbg=bg ctermfg=104 guibg=bg guifg=#6600cc cterm=bold gui=NONE
  ...
  hi CursorLineNr ctermbg=NONE ctermfg=NONE guibg=bg guifg=#1a1a1a cterm=bold gui=NONE
  hi Define ctermbg=bg ctermfg=75 guibg=bg guifg=#1e90ff cterm=bold gui=NONE
  hi Delimiter ctermbg=bg ctermfg=31 guibg=bg guifg=#006699 cterm=bold gui=NONE
  hi Directory ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=NONE
  hi Exception ctermbg=bg ctermfg=104 guibg=bg guifg=#6600cc cterm=bold gui=NONE
  ...
  hi Function ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=NONE
  hi Identifier ctermbg=bg ctermfg=75 guibg=bg guifg=#1e90ff cterm=bold gui=NONE
  hi Include ctermbg=bg ctermfg=31 guibg=bg guifg=#006699 cterm=bold gui=NONE
  ...
  hi Keyword ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=NONE
  hi Label ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=NONE
  ...
  hi NONEd ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=NONE
  hi Operator ctermbg=bg ctermfg=104 guibg=bg guifg=#6600cc cterm=bold gui=NONE
  hi PreCondit ctermbg=bg ctermfg=75 gui=NONE guibg=bg guifg=#1e90ff
  hi Question ctermbg=bg ctermfg=31 guibg=bg guifg=#006699
  hi Repeat ctermbg=bg ctermfg=104 guibg=bg guifg=#6600cc cterm=bold gui=NONE
  hi RubySymbol ctermbg=bg ctermfg=104 guibg=bg guifg=#6600cc cterm=bold gui=NONE
  hi Special ctermbg=bg ctermfg=31 guibg=bg guifg=#006699 cterm=bold gui=NONE
  hi SpecialKey ctermbg=bg ctermfg=75 gui=NONE guibg=bg guifg=#1e90ff
  hi Statement ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=NONE
  hi StorageClass ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=NONE
  hi Structure ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=NONE
  ...
  hi Tag ctermbg=bg ctermfg=37 guibg=bg guifg=#009999 cterm=bold gui=NONE
  hi Type ctermbg=bg ctermfg=37 guibg=bg guifg=#009999 cterm=bold gui=NONE
  ...
  hi Number ctermbg=bg ctermfg=104 guibg=bg guifg=#6600cc cterm=bold gui=NONE
  hi Constant ctermbg=bg ctermfg=104 guibg=bg guifg=#6600cc cterm=bold gui=NONE
  hi PreProc ctermbg=bg ctermfg=104 guibg=bg guifg=#6600cc cterm=bold gui=NONE
  hi Float ctermbg=bg ctermfg=104 guibg=bg guifg=#6600cc cterm=bold gui=NONE
else
  ...
  hi Conditional ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=NONE
  ...
  hi CursorLineNr ctermbg=59 ctermfg=226 guibg=bg guifg=#ffff99 cterm=bold gui=NONE
  hi Define ctermbg=bg ctermfg=75 guibg=bg guifg=#33adff cterm=bold gui=NONE
  hi Delimiter ctermbg=bg ctermfg=157 guibg=bg guifg=#a3ffa3 cterm=bold gui=NONE
  hi Directory ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=NONE
  hi Exception ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=NONE
  ...
  hi Function ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=NONE
  hi Identifier ctermbg=bg ctermfg=75 guibg=bg guifg=#33adff cterm=bold gui=NONE
  hi Include ctermbg=bg ctermfg=157 guibg=bg guifg=#a3ffa3 cterm=bold gui=NONE
  ...
  hi Keyword ctermbg=bg ctermfg=228 guibg=bg guifg=#ffff99 cterm=bold gui=NONE
  hi Label ctermbg=bg ctermfg=157 guibg=bg guifg=#a3ffa3 cterm=bold gui=NONE
  hi LineNr ctermbg=bg ctermfg=214 gui=NONE guibg=#474747 guifg=#eaeaea
  hi MatchParen term=reverse ctermbg=104 ctermfg=16 guibg=#adff2f guifg=#000000 cterm=bold gui=NONE
  ...
  hi NONEd ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=NONE
  hi Operator ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=NONE
  ...
  hi Repeat ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=NONE
  hi RubySymbol ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=NONE
  hi Special ctermbg=bg ctermfg=157 guibg=bg guifg=#a3ffa3 cterm=bold gui=NONE
  ...
  hi Tag ctermbg=bg ctermfg=37 guibg=bg guifg=#00cc99 cterm=bold gui=NONE
  hi Type ctermbg=bg ctermfg=37 guibg=bg guifg=#00cc99 cterm=bold gui=NONE
  ...
  hi Number ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=NONE
  hi Constant ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=NONE
  hi PreProc ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=NONE
  hi Float ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=NONE
endif
...
hi StatusLine term=reverse cterm=reverse ctermbg=102 ctermfg=214 gui=reverse guibg=#eaeaea guifg=#666666 cterm=bold gui=NONE
hi String ctermbg=bg ctermfg=202 gui=NONE guibg=bg guifg=#ff6600
hi Todo ctermbg=226 ctermfg=102 gui=italic guibg=#ffff99 guifg=#666666 cterm=bold gui=NONE
...
hi Title ctermbg=153 ctermfg=199 guibg=#87cefa guifg=#ff1493 cterm=bold gui=NONE
hi Macro ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=NONE
hi NERDTreeBookmarksLeader ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=NONE
