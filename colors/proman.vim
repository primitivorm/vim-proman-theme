...
if &background=="light"
  ...
  hi Directory ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=bold
  ...
  hi Label ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=bold
  ...
  hi NONEd ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=bold
  ...
  hi RubySymbol ctermbg=bg ctermfg=104 guibg=bg guifg=#6600cc cterm=bold gui=bold
  ...
  hi Number ctermbg=bg ctermfg=104 guibg=bg guifg=#6600cc cterm=bold gui=bold
  hi Constant ctermbg=bg ctermfg=104 guibg=bg guifg=#6600cc cterm=bold gui=bold
  hi PreProc ctermbg=bg ctermfg=104 guibg=bg guifg=#6600cc cterm=bold gui=bold
  hi Float ctermbg=bg ctermfg=104 guibg=bg guifg=#6600cc cterm=bold gui=bold
else
  ...
  hi Directory ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=bold
  hi Exception ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=bold
  ...
  hi Repeat ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=bold
  hi RubySymbol ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=bold
  ...
  hi Number ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=bold
  hi Constant ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=bold
  hi PreProc ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=bold
  hi Float ctermbg=bg ctermfg=104 guibg=bg guifg=#ad85ff cterm=bold gui=bold
endif
...
hi Title ctermbg=153 ctermfg=199 guibg=#87cefa guifg=#ff1493 cterm=bold gui=bold
hi Macro ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=bold
hi NERDTreeBookmarksLeader ctermbg=bg ctermfg=199 guibg=bg guifg=#ff1493 cterm=bold gui=bold
