...
hi Statement            guifg=#4B0082 ctermfg=16 gui=bold cterm=bold
...
hi PreProc              guifg=#ff00ff ctermfg=102 gui=bold cterm=bold
    ...
    hi PreCondit        guifg=#ff4500 ctermfg=102

hi Type                 guifg=#009999 ctermfg=60 gui=bold cterm=bold
...
hi CursorLine           guifg=NONE ctermfg=NONE guibg=#E6E6FA ctermbg=230 cterm=bold term=bold gui=underline
...
hi LineNr               guifg=#009999 ctermfg=59 guibg=#eaeaea ctermbg=188
hi ModeMsg              gui=bold cterm=bold
hi Normal               guifg=#101010 ctermfg=16 guibg=#F8F8FF ctermbg=231
hi Pmenu                guibg=#ffff8c ctermbg=145 guifg=#555753 ctermfg=59
...
hi SpecialKey guifg=#1E90FF ctermfg=192
hi NonText guifg=#1E90FF ctermfg=192
