...
if &background=="light"
  ...
  hi CursorColumn term=bold cterm=NONE ctermbg=NONE ctermfg=NONE gui=NONE guibg=NONE guifg=NONE
  hi CursorLine term=bold cterm=underline ctermbg=NONE ctermfg=59 gui=underline guibg=NONE guifg=#333333
  hi Cursor term=NONE cterm=NONE ctermbg=124 ctermfg=231 gui=bold guibg=#a61717 guifg=#f5f5ff
  ...
  hi Search term=reverse cterm=NONE ctermbg=153 ctermfg=16 gui=NONE guibg=#87cefa guifg=#000000
  hi MoreMsg term=bold cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=#2e8b57
  hi Cursor term=NONE cterm=NONE ctermbg=231 ctermfg=124 gui=bold guibg=#ebebff guifg=#a61717
  ...
  hi CursorColumn term=bold cterm=NONE ctermbg=NONE ctermfg=NONE gui=NONE guibg=NONE guifg=NONE
  hi CursorLine term=bold cterm=underline ctermbg=NONE ctermfg=231 gui=underline guibg=NONE guifg=#f5f5ff
