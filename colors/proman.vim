...
if &background=="light"
  ...
  hi Function ctermbg=bg ctermfg=126 gui=bold guibg=bg guifg=#cc0066
  ...
  hi Statement ctermbg=bg ctermfg=126 gui=bold guibg=bg guifg=#cc0066
...
hi String ctermbg=bg ctermfg=202 gui=bold guibg=bg guifg=#ff6600
