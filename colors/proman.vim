...
if &background == "light"
  ...
  hi! Typedef   guibg=bg guifg=#009999 ctermfg=30 cterm=NONE gui=NONE
  ...
  hi! Typedef guibg=bg guifg=#00cc99 ctermfg=42 cterm=NONE gui=NONE
...
hi! Structure   guibg=bg guifg=#FF72BE ctermfg=168 cterm=NONE gui=NONE
hi! Statement   guibg=bg guifg=#FF72BE ctermfg=168 cterm=NONE gui=NONE
hi! StorageClass   guibg=bg guifg=#FF72BE ctermfg=168 cterm=NONE gui=NONE
