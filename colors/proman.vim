...
hi Directory ctermbg=bg ctermfg=104 gui=NONE guibg=bg guifg=#6a5acd
...
hi Statement ctermbg=bg ctermfg=104 gui=NONE guibg=bg guifg=#6a5acd
hi StatusLine term=reverse cterm=reverse ctermbg=102 ctermfg=2104 gui=reverse guibg=#eaeaea guifg=#666666
hi StorageClass ctermbg=bg ctermfg=104 gui=NONE guibg=bg guifg=#6a5acd
hi String ctermbg=bg ctermfg=202 gui=NONE guibg=bg guifg=#FF944D
hi Structure ctermbg=bg ctermfg=104 gui=NONE guibg=bg guifg=#6a5acd
